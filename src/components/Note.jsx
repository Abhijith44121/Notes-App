const Note = ({note , deleteNote}) => {
    ...
    <div
     key={note.id}
      className='p-4 bg-white rounded-lg shadow-md border-l-4 text-left'
      ...
      <button onClick = {()=> deleteNote(note.id) }className="mt-3 text-red-500 cursor-pointer transition hover:text-red-700 font-semibold">🗑️Delete</button>
    </div>
    );
}
